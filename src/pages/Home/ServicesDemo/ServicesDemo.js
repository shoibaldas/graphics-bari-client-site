    ...
    return (
        <div>
            ...
            <div className='grid place-items-center md:max-w-screen-lg md:mx-auto py-6'>
                ...
                <div className='my-8'>
                    <Link to='/' className='outline outline-offset-2 outline-1 rounded px-4 py-2 border-sky-700 text-sky-700 font-semibold hover:bg-sky-700 hover:text-gray-100 hover:outline-none ease-in duration-300'>See All</Link>
                </div>
            </div>
        </div>
    );
